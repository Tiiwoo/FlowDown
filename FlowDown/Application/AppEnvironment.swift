...
nonisolated extension AppEnvironment.Container {
    nonisolated static func live() throws -> AppEnvironment.Container {
        ...
        #if TEST_SIMULATOR_DISABLE_CLOUD_KIT // enabled from xcconfig generated by ci test
            let mode: SyncEngine.Mode = .mock
            let automaticallySync = false
        #else
            let mode: SyncEngine.Mode = .live
